...
_Serial1Init_PARM_2:
	.ds 1
_ClockMilliSecondsDelay_ms_1_131:
	.ds 4
;--------------------------------------------------------
...
;------------------------------------------------------------
;	tinibios.c:286: void Serial0SendBreak()
;	-----------------------------------------
...
;------------------------------------------------------------
;	tinibios.c:293: void Serial0Flush()
;	-----------------------------------------
...
;------------------------------------------------------------
;	tinibios.c:434: void Serial1SendBreak()
;	-----------------------------------------
...
;------------------------------------------------------------
;	tinibios.c:441: void Serial1Flush()
;	-----------------------------------------
...
;ms                        Allocated with name '_ClockMilliSecondsDelay_ms_1_131'
;------------------------------------------------------------
...
;	tinibios.c:530: long ms=ClockTicks()+delay;
	...
	pop	ar3
	pop	ar2
	mov	dptr,#_ClockMilliSecondsDelay_ms_1_131
	mov	a,r2
	add	a,r6
	movx	@dptr,a
	mov	a,r3
