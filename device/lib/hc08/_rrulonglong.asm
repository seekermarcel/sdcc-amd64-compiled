...
;../_rrulonglong.c:44: b[0] = b[1];
	...
	ldx	((__rrulonglong_PARM_1 + 0x0002) + 1)
	sta	__rrulonglong_PARM_1
	stx	(__rrulonglong_PARM_1 + 1)
;../_rrulonglong.c:45: b[1] = b[2];
	lda	(__rrulonglong_PARM_1 + 0x0004)
	ldx	((__rrulonglong_PARM_1 + 0x0004) + 1)
	sta	(__rrulonglong_PARM_1 + 0x0002)
	stx	((__rrulonglong_PARM_1 + 0x0002) + 1)
;../_rrulonglong.c:46: b[2] = b[3];
	lda	(__rrulonglong_PARM_1 + 0x0006)
	ldx	((__rrulonglong_PARM_1 + 0x0006) + 1)
	sta	(__rrulonglong_PARM_1 + 0x0004)
	stx	((__rrulonglong_PARM_1 + 0x0004) + 1)
...
;../_rrulonglong.c:51: (*middle) |= (((*middle) & 0xffff0000ul) >> s);
	ldx	(__rrulonglong_PARM_1 + 0x0003)
	lda	((__rrulonglong_PARM_1 + 0x0003) + 1)
	sta	*(__rrulonglong_sloc1_1_0 + 3)
	stx	*(__rrulonglong_sloc1_1_0 + 2)
...
00120$:
	...
	pshh
	pula
	sta	(__rrulonglong_PARM_1 + 0x0003)
	stx	((__rrulonglong_PARM_1 + 0x0003) + 1)
