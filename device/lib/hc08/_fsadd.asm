...
;../_fsadd.c:179: exp2 = EXP (*pfl2);
	...
	sta	(___fsadd_exp2_1_21 + 1)
	lda	*(___fsadd_sloc2_1_0 + 2)
	sta	___fsadd_exp2_1_21
...
;../_fsadd.c:188: exp1 = EXP (*pfl1);
	...
	mov	#0x00,*(___fsadd_sloc0_1_0 + 1)
	mov	#0x00,*___fsadd_sloc0_1_0
	ldx	*(___fsadd_sloc0_1_0 + 3)
	lda	*(___fsadd_sloc0_1_0 + 2)
	psha
	pulh
;../_fsadd.c:189: mant1 = MANT (*pfl1) << 4;
	mov	*(___fsadd_sloc1_1_0 + 3),*(___fsadd_sloc0_1_0 + 3)
	mov	*(___fsadd_sloc1_1_0 + 2),*(___fsadd_sloc0_1_0 + 2)
	lda	*(___fsadd_sloc1_1_0 + 1)
	and	#0x7F
	sta	*(___fsadd_sloc0_1_0 + 1)
	mov	#0x00,*___fsadd_sloc0_1_0
...
;../_fsadd.c:192: mant1 = -mant1;
	clra
	sub	*(___fsadd_sloc0_1_0 + 3)
	sta	(___fsadd_mant1_1_21 + 3)
	clra
	sbc	*(___fsadd_sloc0_1_0 + 2)
	sta	(___fsadd_mant1_1_21 + 2)
	clra
	sbc	*(___fsadd_sloc0_1_0 + 1)
	sta	(___fsadd_mant1_1_21 + 1)
	clra
	sbc	*___fsadd_sloc0_1_0
	sta	___fsadd_mant1_1_21
00108$:
...
;../_fsadd.c:197: expd = exp1 - exp2;
	txa
	sub	(___fsadd_exp2_1_21 + 1)
	sta	*(___fsadd_sloc2_1_0 + 1)
	pshh
	pula
	sbc	___fsadd_exp2_1_21
	sta	*___fsadd_sloc2_1_0
;../_fsadd.c:198: if (expd > 25)
	lda	#0x19
	sub	*(___fsadd_sloc2_1_0 + 1)
	clra
	sbc	*___fsadd_sloc2_1_0
	bge	00112$
...
;../_fsadd.c:205: expd = -expd;
	clra
	sub	*(___fsadd_sloc2_1_0 + 1)
	sta	(___fsadd_expd_1_21 + 1)
	clra
	sbc	*___fsadd_sloc2_1_0
	sta	___fsadd_expd_1_21
;../_fsadd.c:206: exp1 += expd;
	txa
	add	(___fsadd_expd_1_21 + 1)
	tax
	pshh
	pula
	adc	___fsadd_expd_1_21
	psha
	pulh
;../_fsadd.c:207: mant1 >>= expd;
	lda	(___fsadd_expd_1_21 + 1)
	beq	00230$
00229$:
	psha
...
00142$:
	...
	rora
	sta	*(___fsadd_sloc1_1_0 + 1)
	stx	*___fsadd_sloc1_1_0
	mov	#0x00,*(___fsadd_sloc1_1_0 + 3)
	mov	#0x00,*(___fsadd_sloc1_1_0 + 2)
	lda	*(___fsadd_sloc2_1_0 + 3)
