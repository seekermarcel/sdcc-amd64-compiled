...
00104$:
	...
	beq	00106$
	ldhx	_memcmp_buf1_1_21
	sthx	*_memcmp_sloc1_1_0
	ldhx	*_memcmp_sloc1_1_0
	lda	,x
	ldhx	_memcmp_PARM_2
	sthx	*_memcmp_sloc2_1_0
	ldhx	*_memcmp_sloc2_1_0
	ldx	,x
	stx	*_memcmp_sloc3_1_0
	cmp	*_memcmp_sloc3_1_0
	bne	00106$
...
;../_memcmp.c:41: return( *((unsigned char *)buf1) - *((unsigned char *)buf2) );
	...
	ldhx	_memcmp_PARM_2
	ldx	,x
	stx	*(_memcmp_sloc1_1_0 + 1)
	mov	#0x00,*_memcmp_sloc1_1_0
