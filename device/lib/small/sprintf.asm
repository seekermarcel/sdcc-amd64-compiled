...
;buf                       Allocated with name '_vsprintf_buf_1_17'
...
;	-----------------------------------------
_vsprintf:
	mov	_vsprintf_buf_1_17,dpl
	mov	(_vsprintf_buf_1_17 + 1),dph
	mov	(_vsprintf_buf_1_17 + 2),b
;	sprintf.c:44: i = _print_format (put_char_to_string, &buf, format, ap);
	mov	__print_format_PARM_2,#_vsprintf_buf_1_17
	...
	mov	r7,dph
;	sprintf.c:45: *buf = 0;
	mov	r3,_vsprintf_buf_1_17
	mov	r4,(_vsprintf_buf_1_17 + 1)
	mov	r5,(_vsprintf_buf_1_17 + 2)
	mov	dpl,r3
	mov	dph,r4
	mov	b,r5
	clr	a
