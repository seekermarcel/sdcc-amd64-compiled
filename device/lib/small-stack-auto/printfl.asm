...
; This file was generated Mon Apr  4 14:10:51 2022
;--------------------------------------------------------
	.module printfl
...
;buffer                    Allocated with name '_printf_small_buffer_4_38'
;------------------------------------------------------------
...
;	printfl.c:184: _ltoa (val, buffer, radix);
	push	ar7
	push	_radix
	mov	a,#_printf_small_buffer_4_38
	push	acc
	mov	a,#(_printf_small_buffer_4_38 >> 8)
	push	acc
	mov	a,#0x40
	push	acc
	mov	dpl,_val
...
;	printfl.c:185: stri = buffer;
	mov	r1,#_printf_small_buffer_4_38
