...
;string                    Allocated with name '_strpbrk_string_1_22'
;ret                       Allocated with name '_strpbrk_ret_1_23'
;p                         Allocated with name '_strpbrk_p_2_24'
;------------------------------------------------------------
