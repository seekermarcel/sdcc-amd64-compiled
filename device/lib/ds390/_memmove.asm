...
;dst                       Allocated with name '_memmove_dst_1_22'
;ret                       Allocated with name '_memmove_ret_1_23'
;d                         Allocated with name '_memmove_d_1_23'
