...
_charsOutputted:
	.ds 2
__output_char_c_1_55:
	.ds 1
_output_digit_n_1_57:
	.ds 1
_output_2digits_b_1_60:
	.ds 1
...
__print_format_PARM_4:
	.ds 1
__print_format_pfn_1_66:
	.ds 2
__print_format_radix_1_67:
	.ds 1
__print_format_width_1_67:
	.ds 1
__print_format_decimals_1_67:
	.ds 1
__print_format_length_1_67:
	.ds 1
__print_format_c_1_67:
	.ds 1
...
;------------------------------------------------------------
;c                         Allocated with name '__output_char_c_1_55'
;------------------------------------------------------------
...
;n                         Allocated with name '_output_digit_n_1_57'
;------------------------------------------------------------
...
;------------------------------------------------------------
;b                         Allocated with name '_output_2digits_b_1_60'
;------------------------------------------------------------
...
_output_2digits:
	mov	a,dpl
	mov	dptr,#_output_2digits_b_1_60
	movx	@dptr,a
...
_calculate_digit:
	mov	a,dpl
	mov	dptr,#_calculate_digit_radix_1_62
	movx	@dptr,a
...
;	printf_large.c:206: } while (--i);
	...
	dec	a
	mov	r2,a
	mov	_calculate_digit_i_1_63,r2
	jnz	00103$
...
;pfn                       Allocated with name '__print_format_pfn_1_66'
;radix                     Allocated with name '__print_format_radix_1_67'
;width                     Allocated with name '__print_format_width_1_67'
;decimals                  Allocated with name '__print_format_decimals_1_67'
;length                    Allocated with name '__print_format_length_1_67'
;c                         Allocated with name '__print_format_c_1_67'
;memtype                   Allocated with name '__print_format_memtype_5_84'
...
__print_format:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#__print_format_pfn_1_66
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;	printf_large.c:487: radix           = 0;
	mov	dptr,#__print_format_radix_1_67
	clr	a
	movx	@dptr,a
;	printf_large.c:488: width           = 0;
	mov	dptr,#__print_format_width_1_67
	movx	@dptr,a
;	printf_large.c:489: decimals        = -1;
	mov	dptr,#__print_format_decimals_1_67
	dec	a
	movx	@dptr,a
...
;	printf_large.c:493: c = *format++;
	...
	inc	dptr
	movx	@dptr,a
	mov	dptr,#__print_format_c_1_67
	mov	a,r3
	movx	@dptr,a
...
;	printf_large.c:603: if ( left_justify && (length < width))
	jb	__print_format_left_justify_1_67,00545$
	ljmp	00172$
00545$:
	mov	dptr,#__print_format_width_1_67
	movx	a,@dptr
...
;	printf_large.c:729: if (!signed_argument)
	jnb	__print_format_signed_argument_1_67,00560$
	ljmp	00185$
00560$:
...
;	printf_large.c:758: do {
	mov	__print_format_sloc2_1_0,#(__print_format_store_4_88 + 0x0005)
	mov	(__print_format_sloc2_1_0 + 1),#((__print_format_store_4_88 + 0x0005) >> 8)
...
;	printf_large.c:778: if (width == 0)
	mov	dptr,#__print_format_pstore_4_88
	mov	a,__print_format_sloc2_1_0
	movx	@dptr,a
	mov	a,(__print_format_sloc2_1_0 + 1)
	inc	dptr
	movx	@dptr,a
	mov	dptr,#__print_format_length_1_67
	mov	a,__print_format_sloc0_1_0
	movx	@dptr,a
	mov	dptr,#__print_format_width_1_67
	movx	a,@dptr
...
;	printf_large.c:856: if (left_justify)
	jb	__print_format_left_justify_1_67,00583$
	ljmp	00243$
00583$:
