...
;--------------------------------------------------------
	.area XSEG    (XDATA)
_rtc	=	0x310000
_RtcRead_rtcDate_1_83:
	.ds 4
_RtcRead_rtcBytes_1_84:
	.ds 8
_RtcWrite_rtcBytes_1_90:
	.ds 8
;--------------------------------------------------------
...
;------------------------------------------------------------
;rtcDate                   Allocated with name '_RtcRead_rtcDate_1_83'
;rtcBytes                  Allocated with name '_RtcRead_rtcBytes_1_84'
;byte                      Allocated to registers 
;bitMask                   Allocated to registers r3 
;------------------------------------------------------------
...
_RtcRead:
	mov     dps, #1
	mov     dptr, #_RtcRead_rtcDate_1_83
	mov	a,dpl
	movx	@dptr,a
	inc	dptr
	mov	a,dph
...
;	rtc390.c:68: rtcBytes[byte]=0;
	mov	a,r6
	add	a,#_RtcRead_rtcBytes_1_84
	mov	dpl,a
	clr	a
	addc	a,#(_RtcRead_rtcBytes_1_84 >> 8)
	mov	dph,a
	clr	a
	addc	a,#(_RtcRead_rtcBytes_1_84 >> 16)
	mov	dpx,a
	clr	a
	movx	@dptr,a
...
;	rtc390.c:75: rtcDate->tm_year=BCDtoINT(rtcBytes[7])+100; // year since 1900
	...
	movx	a,@dptr
	mov	r1,a
	mov	dptr,#(_RtcRead_rtcBytes_1_84 + 0x000007)
	movx	a,@dptr
	mov	r2,a
	mov	a,#0x0F
	anl	a,r2
...
;	rtc390.c:76: rtcDate->tm_mon=BCDtoINT(rtcBytes[6])-1; // jan=0
	...
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#(_RtcRead_rtcBytes_1_84 + 0x000006)
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x0F
	anl	a,r6
...
;	rtc390.c:77: rtcDate->tm_mday=BCDtoINT(rtcBytes[5]);
	...
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#(_RtcRead_rtcBytes_1_84 + 0x000005)
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x0F
	anl	a,r6
...
;	rtc390.c:78: rtcDate->tm_wday=(rtcBytes[4]&0x07)-1; // monday=0?
	...
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#(_RtcRead_rtcBytes_1_84 + 0x000004)
	movx	a,@dptr
	mov	r6,a
	anl	ar6,#0x07
	dec	r6
...
;	rtc390.c:79: rtcDate->tm_hour=BCDtoINT(rtcBytes[3]);
	...
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#(_RtcRead_rtcBytes_1_84 + 0x000003)
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x0F
	anl	a,r6
...
;	rtc390.c:80: rtcDate->tm_min=BCDtoINT(rtcBytes[2]);
	...
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#(_RtcRead_rtcBytes_1_84 + 0x000002)
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x0F
	anl	a,r6
...
;	rtc390.c:81: rtcDate->tm_sec=BCDtoINT(rtcBytes[1]);
	mov	dptr,#(_RtcRead_rtcBytes_1_84 + 0x000001)
	movx	a,@dptr
	mov	r2,a
	mov	a,#0x0F
	anl	a,r2
...
;	rtc390.c:82: rtcDate->tm_hundredth=BCDtoINT(rtcBytes[0]);
	...
	movx	a,@dptr
	mov	r5,a
	mov	dptr,#_RtcRead_rtcBytes_1_84
	movx	a,@dptr
	mov	r6,a
	mov	a,#0x0F
	anl	a,r6
...
;rtcBytes                  Allocated with name '_RtcWrite_rtcBytes_1_90'
;byte                      Allocated to registers 
;bitMask                   Allocated to registers r3 
;------------------------------------------------------------
...
;	genAssign: resultIsFar = TRUE
	...
	add	a,r0
	mov  r0,a
	mov  dptr,#(_RtcWrite_rtcBytes_1_90 + 0x000007)
	movx @dptr,a
;	rtc390.c:95: rtcBytes[6]=INTtoBCD(rtcDate->tm_mon)+1;
	...
	inc  a
	mov  r7,a
	mov	dptr,#(_RtcWrite_rtcBytes_1_90 + 0x000006)
	mov	a,r7
	movx	@dptr,a
;	rtc390.c:96: rtcBytes[5]=INTtoBCD(rtcDate->tm_mday);
	...
	add	a,r7
	mov  r7,a
	mov  dptr,#(_RtcWrite_rtcBytes_1_90 + 0x000005)
	movx @dptr,a
;	rtc390.c:97: rtcBytes[4]=(INTtoBCD(rtcDate->tm_wday)+1)&0x07; //set 24h  mode
	...
	mov  r7,a
	anl	ar7,#0x07
	mov	dptr,#(_RtcWrite_rtcBytes_1_90 + 0x000004)
	mov	a,r7
	movx	@dptr,a
;	rtc390.c:98: rtcBytes[3]=INTtoBCD(rtcDate->tm_hour)&0x3f; // oscilator on, reset on
	...
	mov	r7,a
	anl	ar7,#0x3F
	mov	dptr,#(_RtcWrite_rtcBytes_1_90 + 0x000003)
	mov	a,r7
	movx	@dptr,a
;	rtc390.c:99: rtcBytes[2]=INTtoBCD(rtcDate->tm_min);
	...
	add	a,r7
	mov  r7,a
	mov  dptr,#(_RtcWrite_rtcBytes_1_90 + 0x000002)
	movx @dptr,a
;	rtc390.c:100: rtcBytes[1]=INTtoBCD(rtcDate->tm_sec);
	...
	add	a,r3
	mov  r3,a
	mov  dptr,#(_RtcWrite_rtcBytes_1_90 + 0x000001)
	movx @dptr,a
;	rtc390.c:102: rtcBytes[0]=0;
	mov	dptr,#_RtcWrite_rtcBytes_1_90
	clr	a
	movx	@dptr,a
...
;	genAssign: resultIsFar = TRUE
	mov	r3,#0x01
	mov	a,r2
	add	a,#_RtcWrite_rtcBytes_1_90
	mov	dpl1,a
	clr	a
	addc	a,#(_RtcWrite_rtcBytes_1_90 >> 8)
	mov	dph1,a
	clr	a
	addc	a,#(_RtcWrite_rtcBytes_1_90 >> 16)
	mov	dpx1,a
00103$:
