...
;cur_header                Allocated to registers x h 
;------------------------------------------------------------
...
;../_free.c:137: pthis -= 1; //to start of header
	aix	#-4
	sthx	__sdcc_find_memheader_pthis_1_6
...
00104$:
	cphx	#0x00
	beq	00106$
	cpx	(__sdcc_find_memheader_pthis_1_6 + 1)
	bne	00127$
	pshh
	pula
	cmp	__sdcc_find_memheader_pthis_1_6
	beq	00106$
00127$:
;../_free.c:142: _sdcc_prev_memheader = cur_header;
	sthx	__sdcc_prev_memheader
