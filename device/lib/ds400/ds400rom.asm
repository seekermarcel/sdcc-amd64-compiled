...
;------------------------------------------------------------
;	ds400rom.c:373: unsigned char init_rom(void __xdata *loMem,
;	-----------------------------------------
;	 function init_rom
;	-----------------------------------------
_init_rom:
...
;------------------------------------------------------------
;	ds400rom.c:402: unsigned long task_gettimemillis_long(void) __naked
;	-----------------------------------------
;	 function task_gettimemillis_long
;	-----------------------------------------
_task_gettimemillis_long:
;	naked function: no prologue.
;	ds400rom.c:413: __endasm;
...
;------------------------------------------------------------
;	ds400rom.c:416: unsigned char task_getthreadID(void) __naked
;	-----------------------------------------
;	 function task_getthreadID
;	-----------------------------------------
_task_getthreadID:
;	naked function: no prologue.
;	ds400rom.c:424: __endasm;
; no parameters to load.
	mov 0x1E, #(( 9 * 3) & 0xff) 
	mov 0x1F, #((( 9 * 3) >> 8) & 0xff) 
	lcall __romredirect
...
;------------------------------------------------------------
;	ds400rom.c:427: unsigned int task_gettickreload(void)
;	-----------------------------------------
...
_task_gettickreload:
	...
	ar0 = 0x00
	ar1 = 0x01
;	ds400rom.c:429: return DSS_timerReload;
...
;------------------------------------------------------------
;	ds400rom.c:432: void task_settickreload(unsigned int rl)
;	-----------------------------------------
...
;	ds400rom.c:434: DSS_timerReload = rl;
00101$:
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
