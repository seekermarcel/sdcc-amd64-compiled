...
;sloc5                     Allocated with name '_memmove_sloc5_1_0'
;------------------------------------------------------------
...
;../_memmove.c:42: void * ret = dst;
	stx	_memmove_ret_1_22
	sta	(_memmove_ret_1_22 + 1)
...
;../_memmove.c:52: while (acount--) {
	mov	*_memmove_sloc4_1_0,*_memmove_sloc5_1_0
	mov	*(_memmove_sloc4_1_0 + 1),*(_memmove_sloc5_1_0 + 1)
00101$:
	ldhx	*_memmove_sloc5_1_0
	pshx
	pshh
	ldhx	*_memmove_sloc5_1_0
	aix	#-1
	sthx	*_memmove_sloc5_1_0
	pulh
	pulx
	cphx	#0x00
	beq	00109$
...
;../_memmove.c:61: s = src;
	mov	*_memmove_sloc3_1_0,*_memmove_sloc5_1_0
	mov	*(_memmove_sloc3_1_0 + 1),*(_memmove_sloc5_1_0 + 1)
;../_memmove.c:62: while (acount--) {
00104$:
	mov	*_memmove_sloc4_1_0,*_memmove_sloc3_1_0
	mov	*(_memmove_sloc4_1_0 + 1),*(_memmove_sloc3_1_0 + 1)
	pshx
	pshh
