...
_gmtime_sloc1_1_0:
	.ds 4
_mktime_timeptr_1_83:
	.ds 4
_mktime_year_1_84:
	.ds 2
_mktime_month_1_84:
	.ds 2
_mktime_seconds_1_84:
	.ds 4
;--------------------------------------------------------
...
;------------------------------------------------------------
;timeptr                   Allocated with name '_time_timeptr_1_61'
;now                       Allocated with name '_time_now_1_62'
...
;------------------------------------------------------------
;timeptr                   Allocated with name '_asctime_timeptr_1_67'
...
_asctime:
	mov     dps, #1
	mov     dptr, #_asctime_timeptr_1_67
	mov	a,dpl
	movx	@dptr,a
	inc	dptr
	mov	a,dph
...
;days                      Allocated with name '_gmtime_days_1_74'
...
;------------------------------------------------------------
;timeptr                   Allocated with name '_mktime_timeptr_1_83'
;year                      Allocated with name '_mktime_year_1_84'
;month                     Allocated with name '_mktime_month_1_84'
;i                         Allocated to registers 
;seconds                   Allocated with name '_mktime_seconds_1_84'
