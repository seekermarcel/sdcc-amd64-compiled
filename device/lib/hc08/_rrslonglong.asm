...
00107$:
	...
	tax
00108$:
	sta	(__rrslonglong_PARM_1 + 0x0006)
	stx	((__rrslonglong_PARM_1 + 0x0006) + 1)
;../_rrslonglong.c:42: for(;s >= 16; s-= 16)
	pshh
	pula
	sub	#0x10
...
;../_rrslonglong.c:51: (*bottom) |= ((uint32_t)((*middle) >> s) << 16);
	ldx	(__rrslonglong_PARM_1 + 0x0003)
	lda	((__rrslonglong_PARM_1 + 0x0003) + 1)
	sta	*(__rrslonglong_sloc1_1_0 + 1)
	stx	*__rrslonglong_sloc1_1_0
	pshh
	pulx
	tstx
	beq	00127$
00126$:
	...
	dbnzx	00126$
00127$:
	mov	*(__rrslonglong_sloc1_1_0 + 1),*(__rrslonglong_sloc2_1_0 + 3)
	mov	*__rrslonglong_sloc1_1_0,*(__rrslonglong_sloc2_1_0 + 2)
...
;../_rrslonglong.c:52: (*top) |= (((*middle) & 0xffff0000) >> s);
	...
	lda	((__rrslonglong_PARM_1 + 0x0003) + 1)
	sta	*(__rrslonglong_sloc0_1_0 + 3)
	stx	*(__rrslonglong_sloc0_1_0 + 2)
	mov	#0x00,*(__rrslonglong_sloc0_1_0 + 1)
	mov	#0x00,*__rrslonglong_sloc0_1_0
	mov	#0x00,*(__rrslonglong_sloc0_1_0 + 3)
	mov	#0x00,*(__rrslonglong_sloc0_1_0 + 2)
	pshh
	pulx
	tstx
	beq	00129$
...
00129$:
	lda	*(__rrslonglong_sloc2_1_0 + 3)
	ora	*(__rrslonglong_sloc0_1_0 + 3)
	sta	*(__rrslonglong_sloc2_1_0 + 3)
	lda	*(__rrslonglong_sloc2_1_0 + 2)
	ora	*(__rrslonglong_sloc0_1_0 + 2)
	sta	*(__rrslonglong_sloc2_1_0 + 2)
	lda	*(__rrslonglong_sloc2_1_0 + 1)
	ora	*(__rrslonglong_sloc0_1_0 + 1)
	sta	*(__rrslonglong_sloc2_1_0 + 1)
	lda	*__rrslonglong_sloc2_1_0
	ora	*__rrslonglong_sloc0_1_0
	sta	*__rrslonglong_sloc2_1_0
	lda	*__rrslonglong_sloc2_1_0
	sta	(__rrslonglong_PARM_1 + 0x0004)
	lda	*(__rrslonglong_sloc2_1_0 + 1)
