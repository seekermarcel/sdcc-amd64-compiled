...
00120$:
	pshh
	pula
	sta	___ulong2fs_exp_1_21
	stx	(___ulong2fs_exp_1_21 + 1)
;../_ulong2fs.c:107: if ((a&0x7fffff)==0x7fffff) {
	...
	mov	#0x00,*___ulong2fs_sloc0_1_0
...
;../_ulong2fs.c:115: fl.l = PACK(0,(unsigned long)exp, a);
	lda	(___ulong2fs_exp_1_21 + 1)
	sta	*(___ulong2fs_sloc0_1_0 + 3)
	lda	___ulong2fs_exp_1_21
	sta	*(___ulong2fs_sloc0_1_0 + 2)
	rola	
	clra	
	sbc	#0x00
	...
	mov	#0x00,*(___ulong2fs_sloc0_1_0 + 3)
	mov	#0x00,*(___ulong2fs_sloc0_1_0 + 2)
	lda	*(___ulong2fs_sloc0_1_0 + 3)
	ora	(___ulong2fs_PARM_1 + 3)
	sta	*(___ulong2fs_sloc0_1_0 + 3)
	lda	*(___ulong2fs_sloc0_1_0 + 2)
...
;../_ulong2fs.c:117: return (fl.f);
	...
	sta	*(___ulong2fs_sloc0_1_0 + 3)
	mov	*___ulong2fs_sloc0_1_0,*___SDCC_hc08_ret3
	mov	*(___ulong2fs_sloc0_1_0 + 1),*___SDCC_hc08_ret2
	ldx	*(___ulong2fs_sloc0_1_0 + 2)
	lda	*(___ulong2fs_sloc0_1_0 + 3)
	rts
	.area CSEG    (CODE)
