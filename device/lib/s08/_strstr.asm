...
_strstr:
	sta	(_strstr_str1_1_21 + 1)
	stx	_strstr_str1_1_21
;../_strstr.c:33: const char * cp = str1;
	ldhx	_strstr_str1_1_21
	sthx	_strstr_cp_1_22
;../_strstr.c:37: if ( !*str2 )
	ldhx	_strstr_PARM_2
	sthx	*_strstr_sloc0_1_0
	ldhx	*_strstr_sloc0_1_0
	ldx	,x
	bne	00122$
;../_strstr.c:38: return str1;
	ldx	_strstr_str1_1_21
	lda	(_strstr_str1_1_21 + 1)
	rts
...
;../_strstr.c:43: s2 = str2;
	mov	*_strstr_sloc0_1_0,*_strstr_sloc2_1_0
	mov	*(_strstr_sloc0_1_0 + 1),*(_strstr_sloc2_1_0 + 1)
;../_strstr.c:45: while ( *s1 && *s2 && !(*s1-*s2) )
	mov	*_strstr_sloc1_1_0,*_strstr_sloc3_1_0
	mov	*(_strstr_sloc1_1_0 + 1),*(_strstr_sloc3_1_0 + 1)
00105$:
