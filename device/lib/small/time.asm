...
;now                       Allocated with name '_time_now_1_24'
...
;------------------------------------------------------------
;timeptr                   Allocated with name '_asctime_timeptr_1_29'
...
;	time.c:96: CheckTime(timeptr);
	mov	_asctime_timeptr_1_29,dpl
	mov	(_asctime_timeptr_1_29 + 1),dph
	mov	(_asctime_timeptr_1_29 + 2),b
	lcall	_CheckTime
;	time.c:100: timeptr->tm_year+1900);
	mov	a,#0x05
	add	a,_asctime_timeptr_1_29
	mov	r2,a
	clr	a
	addc	a,(_asctime_timeptr_1_29 + 1)
	mov	r3,a
	mov	r4,(_asctime_timeptr_1_29 + 2)
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	__gptrget
...
;	time.c:99: timeptr->tm_hour, timeptr->tm_min, timeptr->tm_sec, 
	mov	dpl,_asctime_timeptr_1_29
	mov	dph,(_asctime_timeptr_1_29 + 1)
	mov	b,(_asctime_timeptr_1_29 + 2)
	lcall	__gptrget
	mov	r4,a
	...
	addc	a,(_asctime_timeptr_1_29 + 1)
	mov	r6,a
	mov	r7,(_asctime_timeptr_1_29 + 2)
	mov	dpl,r0
	mov	dph,r6
	mov	b,r7
	lcall	__gptrget
...
;	time.c:126: unsigned long epoch=*timep;
	lcall	__gptrget
	mov	_gmtime_epoch_1_36,a
	inc	dptr
	lcall	__gptrget
	mov	(_gmtime_epoch_1_36 + 1),a
	inc	dptr
	lcall	__gptrget
	mov	(_gmtime_epoch_1_36 + 2),a
	inc	dptr
	lcall	__gptrget
	mov	(_gmtime_epoch_1_36 + 3),a
;	time.c:131: lastTime.tm_sec=epoch%60;
	...
	mov	dpl,_gmtime_epoch_1_36
	mov	dph,(_gmtime_epoch_1_36 + 1)
	mov	b,(_gmtime_epoch_1_36 + 2)
	mov	a,(_gmtime_epoch_1_36 + 3)
	lcall	__modulong
	mov	r2,dpl
	mov	_lastTime,r2
;	time.c:132: epoch/=60; // now it is minutes
	...
	mov	a,(_gmtime_epoch_1_36 + 3)
	lcall	__divulong
	mov	_gmtime_epoch_1_36,dpl
	mov	(_gmtime_epoch_1_36 + 1),dph
	mov	(_gmtime_epoch_1_36 + 2),b
	mov	(_gmtime_epoch_1_36 + 3),a
...
;	time.c:137: lastTime.tm_wday=(epoch+4)%7;
	mov	a,#0x04
	add	a,_gmtime_epoch_1_36
	mov	r4,a
	clr	a
	addc	a,(_gmtime_epoch_1_36 + 1)
	mov	r5,a
	clr	a
	addc	a,(_gmtime_epoch_1_36 + 2)
	mov	r6,a
	clr	a
	addc	a,(_gmtime_epoch_1_36 + 3)
	mov	r7,a
...
;	time.c:140: days=0;
	clr	a
	mov	_gmtime_days_1_36,a
	mov	(_gmtime_days_1_36 + 1),a
	mov	(_gmtime_days_1_36 + 2),a
	mov	(_gmtime_days_1_36 + 3),a
...
00119$:
	...
	mov	r4,a
	mov	a,r6
	add	a,_gmtime_days_1_36
	mov	r6,a
	mov	a,r7
	addc	a,(_gmtime_days_1_36 + 1)
	mov	r7,a
	mov	a,r5
	addc	a,(_gmtime_days_1_36 + 2)
	mov	r5,a
	mov	a,r4
	addc	a,(_gmtime_days_1_36 + 3)
	mov	r4,a
	mov	_gmtime_days_1_36,r6
	mov	(_gmtime_days_1_36 + 1),r7
	mov	(_gmtime_days_1_36 + 2),r5
	mov	(_gmtime_days_1_36 + 3),r4
	clr	c
	mov	a,_gmtime_epoch_1_36
	subb	a,r6
	mov	a,(_gmtime_epoch_1_36 + 1)
	subb	a,r7
	mov	a,(_gmtime_epoch_1_36 + 2)
	subb	a,r5
	mov	a,(_gmtime_epoch_1_36 + 3)
	subb	a,r4
	jc	00103$
...
00121$:
	...
	mov	r3,a
	mov	r2,a
	mov	a,_gmtime_days_1_36
	clr	c
	subb	a,r4
	mov	_gmtime_days_1_36,a
	mov	a,(_gmtime_days_1_36 + 1)
	subb	a,r5
	mov	(_gmtime_days_1_36 + 1),a
	mov	a,(_gmtime_days_1_36 + 2)
	subb	a,r3
	mov	(_gmtime_days_1_36 + 2),a
	mov	a,(_gmtime_days_1_36 + 3)
	subb	a,r2
	mov	(_gmtime_days_1_36 + 3),a
;	time.c:147: epoch -= days; // now it is days in this year, starting at 0
	mov	a,_gmtime_epoch_1_36
	clr	c
	subb	a,_gmtime_days_1_36
	mov	_gmtime_epoch_1_36,a
	mov	a,(_gmtime_epoch_1_36 + 1)
	subb	a,(_gmtime_days_1_36 + 1)
	mov	(_gmtime_epoch_1_36 + 1),a
	mov	a,(_gmtime_epoch_1_36 + 2)
	subb	a,(_gmtime_days_1_36 + 2)
	mov	(_gmtime_epoch_1_36 + 2),a
	mov	a,(_gmtime_epoch_1_36 + 3)
	subb	a,(_gmtime_days_1_36 + 3)
	mov	(_gmtime_epoch_1_36 + 3),a
;	time.c:148: lastTime.tm_yday=epoch;
	mov	r4,_gmtime_epoch_1_36
	mov	r5,(_gmtime_epoch_1_36 + 1)
...
;------------------------------------------------------------
;timeptr                   Allocated with name '_mktime_timeptr_1_45'
;year                      Allocated with name '_mktime_year_1_46'
;month                     Allocated with name '_mktime_month_1_46'
;i                         Allocated with name '_mktime_i_1_46'
;seconds                   Allocated with name '_mktime_seconds_1_46'
...
;	-----------------------------------------
_mktime:
	mov	_mktime_timeptr_1_45,dpl
	mov	(_mktime_timeptr_1_45 + 1),dph
	mov	(_mktime_timeptr_1_45 + 2),b
;	time.c:180: int year=timeptr->tm_year+1900, month=timeptr->tm_mon, i;
	mov	a,#0x05
	add	a,_mktime_timeptr_1_45
	mov	r2,a
	clr	a
	addc	a,(_mktime_timeptr_1_45 + 1)
	mov	r3,a
	mov	r4,(_mktime_timeptr_1_45 + 2)
	mov	dpl,r2
	mov	dph,r3
	mov	b,r4
	lcall	__gptrget
	...
	mov	a,#0x6C
	add	a,r2
	mov	_mktime_year_1_46,a
	mov	a,#0x07
	addc	a,r3
	mov	(_mktime_year_1_46 + 1),a
	mov	a,#0x04
	add	a,_mktime_timeptr_1_45
	mov	r0,a
	clr	a
	addc	a,(_mktime_timeptr_1_45 + 1)
	mov	r1,a
	mov	r2,(_mktime_timeptr_1_45 + 2)
	mov	dpl,r0
	mov	dph,r1
	mov	b,r2
	lcall	__gptrget
	mov	r0,a
	mov	_mktime_month_1_46,r0
	mov	(_mktime_month_1_46 + 1),#0x00
;	time.c:183: CheckTime(timeptr);
	mov	dpl,_mktime_timeptr_1_45
	mov	dph,(_mktime_timeptr_1_45 + 1)
	mov	b,(_mktime_timeptr_1_45 + 2)
	lcall	_CheckTime
;	time.c:186: seconds= (year-1970)*(60*60*24L*365);
	mov	a,_mktime_year_1_46
	add	a,#0x4E
	mov	r1,a
	mov	a,(_mktime_year_1_46 + 1)
	addc	a,#0xF8
	mov	r2,a
	...
	mov	a,#0x01
	lcall	__mullong
	mov	_mktime_seconds_1_46,dpl
	mov	(_mktime_seconds_1_46 + 1),dph
	mov	(_mktime_seconds_1_46 + 2),b
	mov	(_mktime_seconds_1_46 + 3),a
;	time.c:189: for (i=1970; i<year; i++) {
	mov	_mktime_sloc0_1_0,_mktime_seconds_1_46
	mov	(_mktime_sloc0_1_0 + 1),(_mktime_seconds_1_46 + 1)
	mov	(_mktime_sloc0_1_0 + 2),(_mktime_seconds_1_46 + 2)
	mov	(_mktime_sloc0_1_0 + 3),(_mktime_seconds_1_46 + 3)
	mov	r6,#0xB2
	mov	r7,#0x07
00110$:
	clr	c
	mov	a,r6
	subb	a,_mktime_year_1_46
	mov	a,r7
	xrl	a,#0x80
	mov	b,(_mktime_year_1_46 + 1)
	xrl	b,#0x80
	subb	a,b
	jnc	00124$
...
;	time.c:189: for (i=1970; i<year; i++) {
	...
	sjmp	00110$
00124$:
	mov	_mktime_seconds_1_46,_mktime_sloc0_1_0
	mov	(_mktime_seconds_1_46 + 1),(_mktime_sloc0_1_0 + 1)
	mov	(_mktime_seconds_1_46 + 2),(_mktime_sloc0_1_0 + 2)
	mov	(_mktime_seconds_1_46 + 3),(_mktime_sloc0_1_0 + 3)
;	time.c:196: for (i=0; i<month; i++) {
	mov	__modsint_PARM_2,#0x04
	mov	(__modsint_PARM_2 + 1),#0x00
	mov	dpl,_mktime_year_1_46
	mov	dph,(_mktime_year_1_46 + 1)
	lcall	__modsint
	mov	r6,dpl
	mov	r7,dph
	clr	a
	mov	_mktime_i_1_46,a
	mov	(_mktime_i_1_46 + 1),a
00113$:
	clr	c
	mov	a,_mktime_i_1_46
	subb	a,_mktime_month_1_46
	mov	a,(_mktime_i_1_46 + 1)
	xrl	a,#0x80
	mov	b,(_mktime_month_1_46 + 1)
	xrl	b,#0x80
	subb	a,b
	jc	00143$
	ljmp	00108$
...
;	time.c:197: if (i==1 && LEAP_YEAR(year)) { 
	mov	a,#0x01
	cjne	a,_mktime_i_1_46,00144$
	clr	a
	cjne	a,(_mktime_i_1_46 + 1),00144$
	sjmp	00145$
00144$:
	sjmp	00105$
00145$:
...
;	time.c:198: seconds+= 60*60*24L*29;
	mov	a,#0x80
	add	a,_mktime_seconds_1_46
	mov	_mktime_seconds_1_46,a
	mov	a,#0x3B
	addc	a,(_mktime_seconds_1_46 + 1)
	mov	(_mktime_seconds_1_46 + 1),a
	mov	a,#0x26
	addc	a,(_mktime_seconds_1_46 + 2)
	mov	(_mktime_seconds_1_46 + 2),a
	clr	a
	addc	a,(_mktime_seconds_1_46 + 3)
	mov	(_mktime_seconds_1_46 + 3),a
	sjmp	00114$
00105$:
...
;	time.c:196: for (i=0; i<month; i++) {
	inc	_mktime_i_1_46
	clr	a
	cjne	a,_mktime_i_1_46,00147$
	inc	(_mktime_i_1_46 + 1)
00147$:
	ljmp	00113$
00108$:
...
;	time.c:208: return seconds;
	mov	(_mktime_seconds_1_46 + 3),a
	mov	dpl,_mktime_seconds_1_46
	mov	dph,(_mktime_seconds_1_46 + 1)
	mov	b,(_mktime_seconds_1_46 + 2)
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
_monthDays:
