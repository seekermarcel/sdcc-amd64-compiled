...
;../modff.c:35: *y=(long)x;
	ldhx	_modff_PARM_2
	sthx	*_modff_sloc0_1_0
	ldhx	_modff_PARM_1
	sthx	___fs2slong_PARM_1
	ldhx	(_modff_PARM_1 + 2)
	...
	mov	*___SDCC_hc08_ret2,*(_modff_sloc1_1_0 + 1)
	mov	*___SDCC_hc08_ret3,*_modff_sloc1_1_0
...
;../modff.c:36: return (x-*y);
	...
	mov	*___SDCC_hc08_ret2,*(_modff_sloc1_1_0 + 1)
	mov	*___SDCC_hc08_ret3,*_modff_sloc1_1_0
	mov	*_modff_sloc1_1_0,*___SDCC_hc08_ret3
	mov	*(_modff_sloc1_1_0 + 1),*___SDCC_hc08_ret2
