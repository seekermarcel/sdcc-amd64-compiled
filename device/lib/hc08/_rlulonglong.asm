...
;../_rlulonglong.c:51: (*top) |= (((uint32_t)((*middle) & 0xffffu) << s) >> 16);
	ldx	(__rlulonglong_PARM_1 + 0x0002)
	lda	((__rlulonglong_PARM_1 + 0x0002) + 1)
	sta	*(__rlulonglong_sloc1_1_0 + 3)
	stx	*(__rlulonglong_sloc1_1_0 + 2)
	mov	#0x00,*(__rlulonglong_sloc1_1_0 + 1)
	mov	#0x00,*__rlulonglong_sloc1_1_0
	pshh
	pulx
	tstx
	beq	00120$
...
00120$:
	...
	mov	#0x00,*__rlulonglong_sloc1_1_0
	lda	*(__rlulonglong_sloc0_1_0 + 3)
	ora	*(__rlulonglong_sloc1_1_0 + 3)
	sta	*(__rlulonglong_sloc1_1_0 + 3)
	lda	*(__rlulonglong_sloc0_1_0 + 2)
	ora	*(__rlulonglong_sloc1_1_0 + 2)
	sta	*(__rlulonglong_sloc1_1_0 + 2)
	lda	*(__rlulonglong_sloc0_1_0 + 1)
	ora	*(__rlulonglong_sloc1_1_0 + 1)
	sta	*(__rlulonglong_sloc1_1_0 + 1)
	lda	*__rlulonglong_sloc0_1_0
	ora	*__rlulonglong_sloc1_1_0
