...
;../_fsneq.c:84: fl1.f = a1;
	lda	___fsneq_PARM_1
	sta	___fsneq_fl1_1_21
	lda	(___fsneq_PARM_1 + 1)
	sta	(___fsneq_fl1_1_21 + 1)
	lda	(___fsneq_PARM_1 + 2)
	sta	(___fsneq_fl1_1_21 + 2)
	lda	(___fsneq_PARM_1 + 3)
	sta	(___fsneq_fl1_1_21 + 3)
;../_fsneq.c:85: fl2.f = a2;
	lda	___fsneq_PARM_2
	sta	___fsneq_fl2_1_21
	lda	(___fsneq_PARM_2 + 1)
	sta	(___fsneq_fl2_1_21 + 1)
	lda	(___fsneq_PARM_2 + 2)
	sta	(___fsneq_fl2_1_21 + 2)
	lda	(___fsneq_PARM_2 + 3)
	sta	(___fsneq_fl2_1_21 + 3)
;../_fsneq.c:87: if (fl1.l == fl2.l)
	lda	___fsneq_fl1_1_21
	sta	*___fsneq_sloc0_1_0
	lda	(___fsneq_fl1_1_21 + 1)
	sta	*(___fsneq_sloc0_1_0 + 1)
	lda	(___fsneq_fl1_1_21 + 2)
	sta	*(___fsneq_sloc0_1_0 + 2)
	lda	(___fsneq_fl1_1_21 + 3)
	sta	*(___fsneq_sloc0_1_0 + 3)
	lda	___fsneq_fl2_1_21
	sta	*___fsneq_sloc1_1_0
	lda	(___fsneq_fl2_1_21 + 1)
	sta	*(___fsneq_sloc1_1_0 + 1)
	lda	(___fsneq_fl2_1_21 + 2)
	sta	*(___fsneq_sloc1_1_0 + 2)
	lda	(___fsneq_fl2_1_21 + 3)
