...
;	printf_large.c:206: } while (--i);
	...
	dec	a
	mov	r6,a
	mov	_calculate_digit_i_1_63,r6
	jnz	00103$
...
;	printf_large.c:487: radix           = 0;
	mov	r0,#__print_format_radix_1_67
	clr	a
	movx	@r0,a
;	printf_large.c:488: width           = 0;
	mov	r0,#__print_format_width_1_67
	movx	@r0,a
...
;	printf_large.c:603: if ( left_justify && (length < width))
	jb	__print_format_left_justify_1_67,00543$
	ljmp	00172$
00543$:
	mov	r0,#__print_format_width_1_67
	clr	c
...
;	printf_large.c:723: unsigned char MEM_SPACE_BUF_PP *pstore = &store[5];
	mov	r6,#(__print_format_store_4_88 + 0x0005)
...
;	printf_large.c:729: if (!signed_argument)
	pop	ar6
	jnb	__print_format_signed_argument_1_67,00558$
	ljmp	00185$
00558$:
...
;	printf_large.c:856: if (left_justify)
	jb	__print_format_left_justify_1_67,00579$
	ljmp	00243$
00579$:
