...
;../time.c:84: if (timeptr->tm_sec>59) timeptr->tm_sec=59;
	lda	_CheckTime_timeptr_1_24
	psha
	pulh
	ldx	(_CheckTime_timeptr_1_24 + 1)
	ldx	,x
	cpx	#0x3B
	bls	00102$
	lda	_CheckTime_timeptr_1_24
...
;../time.c:100: timeptr->tm_year+1900);
	lda	_asctime_timeptr_1_26
	psha
	pulh
	ldx	(_asctime_timeptr_1_26 + 1)
	lda	6,x
	ldx	5,x
	add	#0x6C
...
;../time.c:180: int year=timeptr->tm_year+1900, month=timeptr->tm_mon, i;
	lda	_mktime_timeptr_1_42
	psha
	pulh
	ldx	(_mktime_timeptr_1_42 + 1)
	lda	6,x
	ldx	5,x
	add	#0x6C
...
00110$:
	txa
	sub	(_mktime_year_1_43 + 1)
	pshh
	pula
	sbc	_mktime_year_1_43
	bge	00124$
...
00113$:
	txa
	sub	(_mktime_month_1_43 + 1)
	pshh
	pula
	sbc	_mktime_month_1_43
	blt	00149$
	jmp	00108$
00149$:
