...
00106$:
	...
	mov	,x+,*__modslong_sloc1_1_0
	mov	,x+,*(__modslong_sloc1_1_0 + 1)
	mov	,x+,*(__modslong_sloc1_1_0 + 2)
	mov	,x+,*(__modslong_sloc1_1_0 + 3)
00107$:
...
00108$:
	...
	mov	,x+,*__modslong_sloc2_1_0
	mov	,x+,*(__modslong_sloc2_1_0 + 1)
	mov	,x+,*(__modslong_sloc2_1_0 + 2)
	mov	,x+,*(__modslong_sloc2_1_0 + 3)
00109$:
	...
	mov	*__modslong_sloc1_1_0,x+
	mov	*(__modslong_sloc1_1_0 + 1),x+
	mov	*(__modslong_sloc1_1_0 + 2),x+
	mov	*(__modslong_sloc1_1_0 + 3),x+
