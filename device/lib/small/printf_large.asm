...
__print_format_PARM_4:
	.ds 1
__print_format_radix_1_67:
	.ds 1
__print_format_width_1_67:
	.ds 1
__print_format_pstore_4_88:
	.ds 1
...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
_calculate_digit_radix_1_62:
	.ds 1
_calculate_digit_ul_1_63:
	.ds 4
_calculate_digit_i_1_63:
	.ds 1
;--------------------------------------------------------
; indirectly addressable internal ram data
;--------------------------------------------------------
	.area ISEG    (DATA)
__print_format_store_4_88:
	.ds 6
;--------------------------------------------------------
...
_lower_case:
	.ds 1
__print_format_left_justify_1_67:
	.ds 1
__print_format_zero_padding_1_67:
	.ds 1
__print_format_prefix_sign_1_67:
	.ds 1
__print_format_prefix_space_1_67:
	.ds 1
__print_format_signed_argument_1_67:
	.ds 1
__print_format_char_argument_1_67:
	.ds 1
__print_format_long_argument_1_67:
	.ds 1
__print_format_float_argument_1_67:
	.ds 1
__print_format_lsd_1_67:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;radix                     Allocated with name '_calculate_digit_radix_1_62'
;ul                        Allocated with name '_calculate_digit_ul_1_63'
;b4                        Allocated to registers r2 
;i                         Allocated with name '_calculate_digit_i_1_63'
;------------------------------------------------------------
...
;	-----------------------------------------
_calculate_digit:
	mov	_calculate_digit_radix_1_62,dpl
;	printf_large.c:191: register unsigned long ul = value.ul;
	mov	_calculate_digit_ul_1_63,(_value + 0)
	mov	(_calculate_digit_ul_1_63 + 1),(_value + 1)
	mov	(_calculate_digit_ul_1_63 + 2),(_value + 2)
	mov	(_calculate_digit_ul_1_63 + 3),(_value + 3)
...
;	printf_large.c:193: register unsigned char i = 32;
	mov	_calculate_digit_i_1_63,#0x20
...
;	printf_large.c:198: b4 |= (ul >> 31) & 0x01;
	mov	a,(_calculate_digit_ul_1_63 + 3)
	rl	a
	anl	a,#0x01
	mov	r7,a
	mov	ar6,r2
...
;	printf_large.c:199: ul <<= 1;
	mov	a,_calculate_digit_ul_1_63
	add	a,_calculate_digit_ul_1_63
	mov	_calculate_digit_ul_1_63,a
	mov	a,(_calculate_digit_ul_1_63 + 1)
	rlc	a
	mov	(_calculate_digit_ul_1_63 + 1),a
	mov	a,(_calculate_digit_ul_1_63 + 2)
	rlc	a
	mov	(_calculate_digit_ul_1_63 + 2),a
	mov	a,(_calculate_digit_ul_1_63 + 3)
	rlc	a
	mov	(_calculate_digit_ul_1_63 + 3),a
;	printf_large.c:201: if (radix <= b4 )
	clr	c
	mov	a,r2
	subb	a,_calculate_digit_radix_1_62
	jc	00104$
...
;	printf_large.c:204: ul |= 1;
	orl	_calculate_digit_ul_1_63,#0x01
00104$:
;	printf_large.c:206: } while (--i);
	mov	a,_calculate_digit_i_1_63
	dec	a
	mov	r7,a
	mov	_calculate_digit_i_1_63,r7
	jnz	00103$
;	printf_large.c:207: value.ul = ul;
	mov	(_value + 0),_calculate_digit_ul_1_63
	mov	(_value + 1),(_calculate_digit_ul_1_63 + 1)
	mov	(_value + 2),(_calculate_digit_ul_1_63 + 2)
	mov	(_value + 3),(_calculate_digit_ul_1_63 + 3)
...
;radix                     Allocated with name '__print_format_radix_1_67'
;width                     Allocated with name '__print_format_width_1_67'
;decimals                  Allocated to registers r4 
;length                    Allocated to registers r5 
;c                         Allocated to registers r7 
;memtype                   Allocated to registers r4 
;pstore                    Allocated with name '__print_format_pstore_4_88'
;sloc0                     Allocated with name '__print_format_sloc0_1_0'
;sloc1                     Allocated with name '__print_format_sloc1_1_0'
;store                     Allocated with name '__print_format_store_4_88'
;------------------------------------------------------------
...
;	printf_large.c:479: left_justify    = 0;
	clr	__print_format_left_justify_1_67
;	printf_large.c:480: zero_padding    = 0;
	clr	__print_format_zero_padding_1_67
;	printf_large.c:481: prefix_sign     = 0;
	clr	__print_format_prefix_sign_1_67
;	printf_large.c:482: prefix_space    = 0;
	clr	__print_format_prefix_space_1_67
;	printf_large.c:483: signed_argument = 0;
	clr	__print_format_signed_argument_1_67
;	printf_large.c:484: char_argument   = 0;
	clr	__print_format_char_argument_1_67
;	printf_large.c:485: long_argument   = 0;
	clr	__print_format_long_argument_1_67
;	printf_large.c:486: float_argument  = 0;
	clr	__print_format_float_argument_1_67
;	printf_large.c:487: radix           = 0;
	mov	__print_format_radix_1_67,#0x00
;	printf_large.c:488: width           = 0;
	mov	__print_format_width_1_67,#0x00
...
;	printf_large.c:505: width = 10*width + c - '0';
	mov	a,__print_format_width_1_67
	mov	b,#0x0A
	mul	ab
	mov	r5,a
	add	a,r7
...
;	printf_large.c:506: if (width == 0)
	mov	__print_format_width_1_67,a
	jnz	00101$
;	printf_large.c:509: zero_padding = 1;
	setb	__print_format_zero_padding_1_67
	sjmp	00101$
00107$:
...
;	printf_large.c:588: if ( ( !left_justify ) && (length < width) )
	jb	__print_format_left_justify_1_67,00289$
	clr	c
	mov	a,r5
	subb	a,__print_format_width_1_67
	jnc	00289$
...
;	printf_large.c:591: while( width-- != 0 )
	mov	r6,__print_format_width_1_67
00136$:
	mov	ar3,r6
	dec	r6
	mov	a,r3
...
;	printf_large.c:597: while ( (c = *PTR)  && (decimals-- > 0))
	sjmp	00136$
00329$:
	mov	__print_format_width_1_67,r6
00289$:
	mov	ar6,r4
00143$:
	mov	dpl,_value
...
;	printf_large.c:603: if ( left_justify && (length < width))
	jb	__print_format_left_justify_1_67,00544$
	ljmp	00172$
00544$:
	clr	c
	mov	a,r5
...
;	printf_large.c:667: signed_argument = 1;
	setb	__print_format_signed_argument_1_67
;	printf_large.c:668: radix = 10;
	mov	__print_format_radix_1_67,#0x0A
;	printf_large.c:669: break;
;	printf_large.c:671: case 'O':
	sjmp	00172$
00167$:
;	printf_large.c:672: radix = 8;
	mov	__print_format_radix_1_67,#0x08
...
;	printf_large.c:693: if (float_argument)
	jnb	__print_format_float_argument_1_67,00238$
...
;	printf_large.c:718: else if (radix != 0)
	mov	a,__print_format_radix_1_67
	jnz	00557$
	ljmp	00243$
00557$:
;	printf_large.c:723: unsigned char MEM_SPACE_BUF_PP *pstore = &store[5];
	mov	__print_format_pstore_4_88,#(__print_format_store_4_88 + 0x0005)
;	printf_large.c:726: if (char_argument)
	jnb	__print_format_char_argument_1_67,00184$
...
;	printf_large.c:729: if (!signed_argument)
	jb	__print_format_signed_argument_1_67,00185$
...
;	printf_large.c:734: else if (long_argument)
	jnb	__print_format_long_argument_1_67,00181$
...
;	printf_large.c:747: if ( signed_argument )
	jnb	__print_format_signed_argument_1_67,00190$
...
;	printf_large.c:765: if (!lsd)
	jb	__print_format_lsd_1_67,00192$
...
;	printf_large.c:778: if (width == 0)
	mov	__print_format_pstore_4_88,r1
	mov	ar5,r6
	mov	a,__print_format_width_1_67
	jnz	00198$
;	printf_large.c:783: width = 1;
	mov	__print_format_width_1_67,#0x01
00198$:
;	printf_large.c:787: if (!zero_padding && !left_justify)
	jb	__print_format_zero_padding_1_67,00203$
	jb	__print_format_left_justify_1_67,00203$
;	printf_large.c:789: while ( width > (unsigned char) (length+1) )
	mov	a,r5
	inc	a
	mov	r6,a
	mov	r4,__print_format_width_1_67
00199$:
	clr	c
	mov	a,r6
	subb	a,r4
...
;	printf_large.c:805: if (prefix_sign)
	jnb	__print_format_prefix_sign_1_67,00208$
...
;	printf_large.c:811: else if (prefix_space)
	jnb	__print_format_prefix_space_1_67,00214$
...
;	printf_large.c:820: if (!left_justify)
	jb	__print_format_left_justify_1_67,00222$
...
;	printf_large.c:824: OUTPUT_CHAR( zero_padding ? '0' : ' ', p );
	jnb	__print_format_zero_padding_1_67,00248$
	mov	r4,#0x30
	sjmp	00249$
00248$:
	mov	r4,#0x20
...
;	printf_large.c:840: if (!lsd)
	jb	__print_format_lsd_1_67,00225$
...
;	printf_large.c:856: if (left_justify)
	jb	__print_format_left_justify_1_67,00580$
	ljmp	00243$
00580$:
