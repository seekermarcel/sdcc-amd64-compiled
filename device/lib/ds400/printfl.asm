...
;buffer                    Allocated with name '_printf_small_buffer_4_84'
;------------------------------------------------------------
...
;	printfl.c:184: _ltoa (val, buffer, radix);
	...
	mov	a,#_printf_small_buffer_4_84
	movx	@dptr,a
	inc	dptr
	clr	a
	movx	@dptr,a
...
;	genAssign: resultIsFar = FALSE
	mov	r0,#_printf_small_buffer_4_84
