...
;../_fsdiv.c:317: mask = 0x1000000;
	ldhx	#0x0100
	sthx	___fsdiv_mask_1_21
	clrh
	sthx	(___fsdiv_mask_1_21 + 2)
;../_fsdiv.c:318: result = 0;
	sthx	___fsdiv_result_1_21
	sthx	(___fsdiv_result_1_21 + 2)
...
00123$:
	...
	sta	*___fsdiv_sloc1_1_0
	ldhx	(___fsdiv_result_1_21 + 2)
	sthx	*(___fsdiv_sloc0_1_0 + 2)
	ldhx	___fsdiv_result_1_21
	sthx	*___fsdiv_sloc0_1_0
	lda	*(___fsdiv_sloc1_1_0 + 3)
	ora	*(___fsdiv_sloc0_1_0 + 3)
	sta	*(___fsdiv_sloc1_1_0 + 3)
	lda	*(___fsdiv_sloc1_1_0 + 2)
